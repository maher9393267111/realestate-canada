...
const ContactPage = () => {
  ...
  return (
    <div dir="ltr">
      ...
      <div className="contact-page pt-16 mb-16">
                  ...
                  <div className="row">
                    <div className="col-lg-12 mb-4">
                      <div className="form-inner">
                        ...
                        type="text" placeholder="Daniel Scoot" />
                      </div>
                    </div>
                    ...
                    <div className="col-lg-6 mb-4">
                      <div className="form-inner">
                        ...
                        type="email" placeholder="Email Us...." />
                      </div>
                    </div>
                    <div className="col-lg-12 mb-4">
                      <div className="form-inner">
                        <label>
                          Where would you like to have your propert?*
                        </label>
                    ...
                    <div className="form-inner col-lg-6 mb-4">
                      <select
                        className="border-none w-full rounded-xl focus:outline-none focus:ring-0 mb-3 py-3"
                         value={language}
