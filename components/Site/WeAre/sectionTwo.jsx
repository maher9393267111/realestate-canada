...
<div className=" container">
<div class="wp-block-uagb-advanced-heading text-white font-[300] !text-xl md:!text-[32px] mt-5  mb-[24px] !text-[#16426F]1"><section class="uagb-heading-text">{language === "en" ? "We Are Committed to High-Quality Real Estate Service":"Nous Nous Engager à Fournir un Service Immobilier de Haute Qualité"}</section>
...
:
<p class="    md:text-start my-6">Chaque client est unique, c'est pourquoi nous nous engageons à vous fournir un service de qualité qui allie professionnalisme et attentiveness. Que vous soyez acheteur ou vendeur, nous sommes ici pour vous aider à réaliser votre projet immobilier en toute confiance.
