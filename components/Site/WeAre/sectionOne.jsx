...
<div>
<div class="wp-block-uagb-advanced-heading font-[300] !text-xl md:!text-[32px] mt-5  mb-[24px] !text-[#16426F]"><section class="uagb-heading-text">About Blue Caribbean Properties</section>

<p class="has-text-align-center  !text-[#16426F]  max-w-[900px] text-center my-6">Blue Caribbean Properties is a real estate agency founded upon the love of the Caribbean and the warmth of Latin American People.  Our team is comprised of highly qualified individuals who are equipped to handle all of your real estate needs.</p>


<p class="has-text-align-center  !text-[#16426F]  max-w-[900px] text-center my-6">Finding and acquiring an international property may seem like a daunting task, but when you have the right team working for you, the process becomes an exciting venture in the most beautiful place on the earth. Your own home..</p>
