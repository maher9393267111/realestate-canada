      ...
      <section className=" text-center sm:text-left w-full sm:w-[68%] xl:w-[100%]">
        ...
        <div>
          <div className="flex gap-4 flex-col md:flex-row justify-betwee px-6 md:px-12 container flex-wrap">
            <p className="m-t flex gap-1 md:w-1/4">
              <span>
                <img
          ...
          <div className=" mt-6 !w-full">
            <p className=" !text-[#16426F] text-xl !font-[font-weight]  !font-rubik  md:!text-[36px]  ">
              We’ll exceed your expectations
            </p>
            <p className="!text-[#16426F] text-xl md:!mt-3 md:pt-3 !font-rubik md:!text-[36px]">
              GUARANTEED
            </p>
